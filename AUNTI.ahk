...
if IB.Result = "Cancel"
	...
	if DirExist("D:\Tickets\FRD-" . IB.Value)
		...
		RunWait "D:\src\buildFraud.bat"
		FileCopy "D:\src\fraudaml\fraud.core\fcs-deploy\target\argo-fraud-4.3.3.0-install-package.zip", "D:\Tickets\FRD-" . IB.Value
		RunWait A_ComSpec " /c wzunzip -d -q D:\Tickets\FRD-" . IB.Value "\argo-fraud-4.3.3.0-install-package.zip D:\Tickets\FRD-" . IB.Value 
